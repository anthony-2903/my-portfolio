...
export const siteConfig = {
  ...
  description:
    "Portafolio profesional de Anthony Janampa, Ingeniero de Sistemas especializado en desarrollo frontend, diseño UI e infraestructura tecnológica en Lima, Perú.",
  locale: "es_PE",
...
export function personJsonLd() {
  return {
    ...
    jobTitle: "Ingeniero de Sistemas y Frontend Developer",
